...
ax1.set_title("(a)  Policy Performance under Increasing Delivery Delays\n"
...
ax2.set_title("(b)  RLInv Advantage over B1 as Delivery Delay Increases\n"
              "Advantage peaks near 72h, then narrows as replenishment becomes physically constrained", fontsize=10.5)
...
# ── Save ──────────────────────────────────────────────────────────────────────
for ext in ["pdf", "png"]:
    out = OUT_DIR / f"fig_lead_sensitivity_results.{ext}"
